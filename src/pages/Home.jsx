...
export function Home() {
  ...
  const filteredEntries = entries
    ...
    .filter((e) => {
      ...
      return e.ai_summary?.toLowerCase().includes(searchTerm.toLowerCase());
    });
      ...
      <div className="max-w-2xl mx-auto px-4 pt-10 pb-6">
        ...
        <div className="relative mb-6">
          ...
          <input
            ...
            className="w-full bg-slate-900 border border-slate-800 rounded-xl pl-10 pr-4 py-2.5 text-sm text-slate-200 focus:outline-none focus:border-violet-500/60 transition-colors placeholder-slate-600"
          />
          {searchTerm && (
            <button
